...
public class comidafeita_tutorial : MonoBehaviour
{

    public static comidafeita_tutorial Instance;
    ...
    void OnTriggerStay2D(Collider2D collision)
    {
        ...
        if (collision.CompareTag("player"))
        {
            ...
            {
                tasegurando = true;
                PLAYER_Tutorial.instamce.segura = true;
                PLAYER_Tutorial.instamce.comidaAtual = gameObject;
            }
        }
